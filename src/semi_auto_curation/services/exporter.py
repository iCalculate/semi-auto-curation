            ...
            writer.writerow(
                {
                    ...
                    "transfer_subthreshold_swing_mv_dec": device.transfer_subthreshold_swing_mv_dec,
                    "transfer_subthreshold_slope_dec_per_v": device.transfer_subthreshold_slope_dec_per_v,
                    "transfer_ss_fit_r2": device.transfer_ss_fit_r2,
                    "transfer_threshold_voltage_v": device.transfer_threshold_voltage_v,
                    "transfer_threshold_voltage_iref_v": device.transfer_threshold_voltage_iref_v,
                    "transfer_threshold_voltage_gm_v": device.transfer_threshold_voltage_gm_v,
                    "transfer_threshold_voltage_cross_v": device.transfer_threshold_voltage_cross_v,
                    "transfer_turn_on_voltage_v": device.transfer_turn_on_voltage_v,
                    "transfer_von_fit_r2": device.transfer_von_fit_r2,
                    "output_max_current_a": device.output_max_current_a,
                    "output_sat_resistance_ohm": device.output_sat_resistance_ohm,
                    "output_on_resistance_ohm": device.output_on_resistance_ohm,
                    "output_linear_slope_a_per_v": device.output_linear_slope_a_per_v,
                    "output_gds_sat_s": device.output_gds_sat_s,
                    "output_ro_sat_ohm": device.output_ro_sat_ohm,
                    "output_id_sat_a": device.output_id_sat_a,
                    "output_lambda_1_v": device.output_lambda_1_v,
                    "output_early_voltage_v": device.output_early_voltage_v,
                    "output_knee_voltage_v": device.output_knee_voltage_v,
                    "csv_path": device.csv_path,
